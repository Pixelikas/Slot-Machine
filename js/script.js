...
const config = {
    ...
    function preload(){
        ...
        this.load.image('background-frame', 'images/bgframe.png');
        this.load.image('frame', 'images/frame.png');
        this.load.image('winline', 'images/winline.png');
        this.load.image('apple', 'images/symbols/apple.png');
        this.load.image('banana', 'images/symbols/banana.png');
        this.load.image('bar', 'images/symbols/bar.png');
        this.load.image('cherry', 'images/symbols/cherry.png');
        this.load.image('grape', 'images/symbols/grape.png');
        this.load.image('lemon', 'images/symbols/lemon.png');
        this.load.image('orange', 'images/symbols/orange.png');
        this.load.image('watermellon', 'images/symbols/watermellon.png');
        this.load.image('playbuttonOn', 'images/buttons/play_button_0.png');
        this.load.image('playbuttonOff', 'images/buttons/play_button_3.png');
